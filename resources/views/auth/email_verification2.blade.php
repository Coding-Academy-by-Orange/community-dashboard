                ...
                <div class="d-flex align-items-center flex-column">
                    <div class="col-md-7 mt-4">
                        ...
                        <div class="card orange-border-color ">
                            <div class="card-body">
                                <h5 class=" ml-3 "><span class="border mr-2 p-1"> step <span class="orange-color">1</span>/3
                                    </span> Email Verification </h5>
                                <hr class="col-sm-11" />
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="form-group col-lg-12 col-md-7  resend text-center">
                                                <p class="text-center">Didn't get the verification code,
                                                    <a href="{{ route('resend.email.verification.submit') }}"> Resend
                                                        Code</a>
                                                </p>
                                                <span style="color: #f16e00">
                                                    <strong>
                                                        If you can not find your confirmation/reset password email in your
                                                        normal inbox, it is worth checking in your spam or junk mail
                                                        section.</strong>
                                                </span>
                                            </div>
