        ...
        <nav role="navigation" id="mainNav" class="navbar navbar-light bg-white navbar-expand-md pt-2 border-bottom pb-0 mb-2 pt-1"
                ...
                <div class="navbar-collapse justify-content-end collapse" id="orange-navbar-collapse">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link active"  style="color: #f16e00 ; border-color : #f16e00" href="/ODC">Generic Digital Centers</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{route('BigByOrange-registration.index')}}">Big By Orange</a></li>
                    </ul>
                    <ul class="navbar-nav">
                        @guest
                ...
                <div class="col-8 mx-auto" style="text-align : right">
                    ...
                    <form class="p-4 p-md-5 rounded-3" action="{{route('ODC.store')}}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="" class="is-required">الاسم الرباعي<span
                                class="sr-only"> (required)</span></label>
                            <div class="input-group ">

                                <input style="margin-left : 10px ; margin-bottom : 10px" name="father_name" placeholder="اسم الأب" type="text"
                                class="form-control email @error('father_name') is-invalid @enderror " id="father_name"
                                value="{{old('father_name')}}" required>

                                <input style="margin-left : 10px ; margin-bottom : 10px" name="first_name" placeholder="الاسم الأول" type="text"
                            ...
                            <div class="input-group ">
                                ...
                                <input style="margin-left : 10px ; margin-bottom : 10px" name="last_name" placeholder="اسم العائلة" type="text"
                                class="form-control email @error('last_name') is-invalid @enderror " id="last_name"
                                value="{{old('last_name')}}" required>

                                <input style="margin-left : 10px ; margin-bottom : 10px" name="grandfather_name" placeholder="اسم الجد" type="text"
                        ...
                        <div class="form-group">
                            <label for="nationality" class="is-required">الجنسية<span
                                    class="sr-only"> (required)</span></label>
                            <div class="input-group ">
                                <select name="nationality" class="form-control email @error('nationality') is-invalid @enderror " value="{{old('nationality')}}" required id="nationality" onchange="showIdentification()">
                                    ...
                                    <option value="Jordanian" @if(old('nationality') == 'Jordanian') selected @endif>أردنية</option>
                                    <option value="NoneJordanian" @if(old('nationality') == 'NoneJordanian') selected @endif>غير أردنية</option>
                                </select>
                            </div>
                        ...
                        <div class="form-group National_ID" style="display:none">
                            <label for="national_id" class="is-required National_ID" style="display:none">الرقم الوطني<span
                                    class="sr-only"> (required)</span></label>
                            <div class="input-group">
                        ...
                        <div class="form-group Passport_No" style="display:none">
                            <label for="passport_number" class="is-required Passport_No">رقم اللجوء أو رقم جواز السفر<span
                                    class="sr-only"> (required)</span></label>
                            <div class="input-group">
                        ...
                        <div class="form-group" id="Other_Nationality" style="display:none">
                            ...
                            <div class="input-group">
                                <input name="other_nationalty" type="text"
                                       class="form-control email Passport_No " id="other_nationalty"
                                       value="{{old('other_nationalty')}}">
                            </div>

                        </div>

                        <div class="form-group">
                            <label for="age" class="is-required">العمر<span
                                    class="sr-only"> (required)</span></label>
                            <div class="input-group ">
                        ...
                        <div class="form-group">
                            <label for="gender" class="is-required">الجنس<span
                                    class="sr-only"> (required)</span></label>
                            <div class="input-group " style="text-align : right ; direction : rtl">
                                <div style="text-align : right ; direction : rtl ;">
                                    <input style=" height:20px; width:20px;" name="gender" value="Male" required type="radio" class=" @error('gender') is-invalid @enderror " id="gender" @if(old('gender') == 'Male') checked @endif>
                                    <label style="padding-right: 8px">ذكر</label>
                                </div>

                                <div style="text-align : right ; direction : rtl ; margin-right : 3vw;">
                                    <input  style=" height:20px; width:20px;" name="gender" value="Female" required type="radio"
                        ...
                        <div class="form-group">
                            <label for="email" class="is-required">البريد الالكتروني<span
                                    class="sr-only"> (required)</span></label>
                            <div class="input-group ">
                        ...
                        <div class="form-group">
                            <label for="mobile" class="is-required">رقم الهاتف<span class="sr-only"> (required)</span></label>
                            <div class="input-group ">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group ">
                                <input name="whatsapp" type="text"
                                       class="form-control mobile" id="whatsapp"
                                       value="{{old('whatsapp')}}">
                            </div>
                            <small>eg: 077********</small>
                        </div>
                        ...
                        <div class="form-group" style="margin-top: 3vw">
                            <label for="education" class="is-required">المستوى التعليمي<span
                                class="sr-only"> (required)</span></label>
                            <div style="text-align : right ; direction : rtl ; margin : 1vw">

                                <input name="education" value="Below Tawjihi" required type="radio" class=" @error('education') is-invalid @enderror " @if(old('education') == 'Below Tawjihi') checked @endif>
                        ...
                        <div class="form-group" style="margin-top: 3vw">
                            <label for="employment" class="is-required">الحالة الوظيفية<span
                                class="sr-only"> (required)</span></label>
                            <div style="text-align : right ; direction : rtl ; margin : 1vw">

                                <input name="employment" value="Part-Time" required type="radio" class=" @error('employment') is-invalid @enderror " @if(old('employment') == 'Part-Time') checked @endif>
                        ...
                        <div class="form-group" style="margin-top: 3vw">
                            <label for="center" class="is-required">الرجاء اختيار المراكز الرقمية<span
                                class="sr-only"> (required)</span></label>
                            <div>
                                <select name="center" class="form-control email @error('center') is-invalid @enderror " id="" required>
                                    <option value="" selected>-- Please Select --</option>
                                    <option value="Irbid" @if(old('center') == 'Irbid') selected @endif>اربد - مركز شباب دير ابي سعيد</option>
                                    <option value="Jerash" @if(old('center') == 'Jerash') selected @endif>جرش - محطة معرفة الكتة</option>
                                    <option value="Zarqa" @if(old('center') == 'Zarqa') selected @endif>الزرقاء - الجامعة الهاشمية</option>
                                    <option value="Madaba" @if(old('center') == 'Madaba') selected @endif>مادبا - محطة معرفة ذيبان</option>
                                    <option value="Shoubak" @if(old('center') == 'Shoubak') selected @endif>معان - مركز شباب الشوبك</option>
                                    <option value="Ma'an" @if(old('center') == "Ma'an") selected @endif>معان - مركز شباب معان</option>
                                </select>
                            </div>
                        ...
                        <div class="form-group" style="margin-top: 3vw">
                            <label for="obstacles" class="is-required">هل لديك أي صعوبات يمكن أن تحد من مشاركتك في التدريب؟<span
                                class="sr-only"> (required)</span></label>
                            <div style="text-align : right ; direction : rtl ; margin : 1vw">

                                <input name="obstacles" value="Yes" required type="radio" id="IHaveObstacles" onchange="showObstacles()" @if(old('obstacles') == 'Yes') checked @endif>
                        ...
                        <div class="form-group" id="obstacles" style="display: none ; margin-top: 3vw">
                            <label for="type_of_obstacles" class="is-required">يرجى اختيار الأقرب وصفاً الى ما تعاني منه<span
                                class="sr-only"> (required)</span></label>
                            <div style="text-align : right ; direction : rtl ; margin : 1vw">

                                <input class="@error('type_of_obstacles') is-invalid @enderror" name="type_of_obstacles[]" value="صعوبات في النظر, حتى مع ارتداء النظارة؟" type="checkbox" @if(is_array(old('type_of_obstacles')) && in_array('صعوبات في النظر, حتى مع ارتداء النظارة؟', old('type_of_obstacles'))) checked @endif>
                                <span style="margin-top: 1vw">صعوبات في النظر, حتى مع ارتداء النظارة؟</span>
                                <br>

                                <input style="margin-top: 15px" class="@error('type_of_obstacles') is-invalid @enderror" name="type_of_obstacles[]" value="صعوبات في السمع, حتى مع وجود جهاز السمع المساعد؟" type="checkbox" @if(is_array(old('type_of_obstacles')) && in_array('صعوبات في السمع, حتى مع وجود جهاز السمع المساعد؟', old('type_of_obstacles'))) checked @endif>
                                <span style="margin-top: 1vw">صعوبات في السمع, حتى مع وجود جهاز السمع المساعد؟</span>
                                <br>

                                <input style="margin-top: 15px" class="@error('type_of_obstacles') is-invalid @enderror" name="type_of_obstacles[]" value="صعوبات في المشي أو صعود الدرج؟" type="checkbox" @if(is_array(old('type_of_obstacles')) && in_array('صعوبات في المشي أو صعود الدرج؟', old('type_of_obstacles'))) checked @endif>
                                <span style="margin-top: 1vw">صعوبات في المشي أو صعود الدرج؟</span>
                                <br>

                                <input style="margin-top: 15px" class="@error('type_of_obstacles') is-invalid @enderror" name="type_of_obstacles[]" value="مشاكل في الذاكرة أو التركيز؟" type="checkbox" @if(is_array(old('type_of_obstacles')) && in_array('مشاكل في الذاكرة أو التركيز؟', old('type_of_obstacles'))) checked @endif>
                                <span style="margin-top: 1vw">مشاكل في الذاكرة أو التركيز؟</span>
                                <br>

                                <input style="margin-top: 15px" class="@error('type_of_obstacles') is-invalid @enderror" name="type_of_obstacles[]" value="صعوبات في العناية الشخصية مثل غسل الملابس وارتداء الملابس؟" type="checkbox" @if(is_array(old('type_of_obstacles')) && in_array('صعوبات في العناية الشخصية مثل غسل الملابس وارتداء الملابس؟', old('type_of_obstacles'))) checked @endif>
                                <span style="margin-top: 1vw">صعوبات في العناية الشخصية مثل غسل الملابس وارتداء الملابس؟</span>
                                <br>

                                <input style="margin-top: 15px" class="@error('type_of_obstacles') is-invalid @enderror" name="type_of_obstacles[]" value="صعوبات في التواصل, مثلاً أن تفهم الآخرين, أو فهم الآخرين لك؟" type="checkbox" @if(is_array(old('type_of_obstacles')) && in_array('صعوبات في التواصل, مثلاً أن تفهم الآخرين, أو فهم الآخرين لك؟', old('type_of_obstacles'))) checked @endif>
                                <span style="margin-top: 1vw">صعوبات في التواصل, مثلاً أن تفهم الآخرين, أو فهم الآخرين لك؟</span>
                                <br>
                        ...
                        <div class="form-group" style="margin-top: 3vw">
                            <label for="programming" class="is-required">تسجيل البرنامج<span
                                class="sr-only"> (required)</span></label>
                            <div style="text-align : right ; direction : rtl ; margin : 1vw">

                                <input onchange="showChossenProgramming()" name="programming[]" value="Career planning and development programme" type="checkbox" @if(is_array(old('programming')) && in_array('Career planning and development programme', old('programming'))) checked @endif>
                                <span style="margin-top: 1vw">برنامج التخطيط والتطوير الوظيفي</span>
                                <br>

                                <input style="margin-top: 15px" onchange="showChossenProgramming()" name="programming[]" value="digital culture" type="checkbox" @if(is_array(old('programming')) && in_array('digital culture', old('programming'))) checked @endif>
                                <span style="margin-top: 1vw">الثقافة الرقمية</span>
                                <br>

                                <input style="margin-top: 15px" onchange="showChossenProgramming()" name="programming[]" value="Life Skills" type="checkbox" @if(is_array(old('programming')) && in_array('Life Skills', old('programming'))) checked @endif>
                                <span style="margin-top: 1vw">المهارات الحياتية</span>
                                <br>

                                <input style="margin-top: 15px" onchange="showChossenProgramming()" name="programming[]" value="Leadership and innovation skills" type="checkbox" @if(is_array(old('programming')) && in_array('Leadership and innovation skills', old('programming'))) checked @endif>

                                <span style="margin-top: 1vw">مهارات الريادة والابتكار</span>
                                <br>

                                <input style="margin-top: 15px" onchange="showChossenProgramming()" name="programming[]" value="Functional skills" type="checkbox" @if(is_array(old('programming')) && in_array('Functional skills', old('programming'))) checked @endif>
                                <span style="margin-top: 1vw">المهارات الوظيفية</span>
                                <br>

                                <input style="margin-top: 15px" onchange="showChossenProgramming()" name="programming[]" class="@error('programming') is-invalid @enderror " value="Other exercises" type="checkbox" @if(is_array(old('programming')) && in_array('Other exercises', old('programming'))) checked @endif>
                        ...
                        <p style="text-align : right ; margin-top: 3vw">البيانات التي تم جمعها من هذه الاستبانة سيتم استخدام النتائج لتتبع مشاركتك في البرنامج و تقييم أداء البرنامج. سيتم التعامل مع إجاباتك بسرية تامة، وما كتبته لن يتم كشفه للآخرين عدا الاشخاص المختصين برصد وتقييم البرنامج. سوف يتم التعامل مع بيانات دراستك بسرية قدر الإمكان ، وجميع الإجراءات متوافقة مع قوانين الخصوصية الأردنية. إذا تم نشر نتائج هذه الدراسة أو تقديمها ،الاسماء الشخصية والفردية سوف تعامل بكامل السري

                            نشكر لكم إهتمامكم بالدورات المقدمة من مراكز أورنج المجتمعية الرقمية الهادفة الى تعزيز مهاراتكم اللي بتحتاجوها لتزيدو فرصكم في سوق العمل
                        ...
                        <div class="form-group" style="text-align : right ; direction : rtl">
                            <div style="text-align : right ; direction :rtl" class="custom-control custom-checkbox">
                                <input class="custom-control-input @error('news') is-invalid @enderror" id="news" name="news" type="checkbox" @if(old('news')) checked @endif>
                                <label class="custom-control-label " for="news">النشرة الاخبارية / أنا أوافق على استلام رسائل الكترونية من شركة اورانج بانتظام (اختياري)</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="text-align : right ; direction : rtl">
                            <div style="text-align : right ; direction :rtl" class="custom-control custom-checkbox">
                                <input class="custom-control-input @error('chAgree') is-invalid @enderror" id="chAgree"
                                       name="chAgree" value="yes" type="checkbox" @if(old('chAgree')) checked @endif required>
                                <label class="custom-control-label " for="chAgree">أوافق على استخدام بياناتي لأغراض التتبع والتقييم<span class="mandatory-txt">*</span></label>
