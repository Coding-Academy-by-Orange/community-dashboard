        ...
        <div class="container position-relative z-0">
            <div class="row pt-3 px-5">
                <div class="col-5 pt-5 z-1">
                    <h1 class="pt-1 pt-md-4 mb-2 mb-md-3 display-3 text-primary">Coding Academy</h1>
                    <h2 class="display-4 text-white">Empowering the Next Generation of Tech Leaders</h2>
                    <p class="ll-sm pt-1 mb-3">Join our Coding Academy and transform your future. Learn the latest in web development, data science, and more from industry experts. Start your journey with us today and be part of the digital revolution.</p>
                    <a href="{{ route('codingacademy.create') }}" class="btn btn-primary">Register Now</a>
                </div>
        ...
        <div class="container text-white py-5">
            <div class="row">
                ...
                <div class="slider-impact row py-5 d-flex justify-content-center align-items-center">
                    ...
                    <div class="col-3 border-start border-light">
                        <div class="text-primary number p-3 display-3">42%</div>
                        <div class="px-3">
                            <div class="display-5 pb-1">Women Participation</div>
                            <p class="ll-sm">42% of our beneficiaries are women, highlighting our commitment to gender equality.</p>
                        </div>
                    </div>
                    <div class="col-3 border-start border-light">
        ...
        <div class="container py-5">
            <div class="row d-flex">
                <div class="col-4 align-self-md-center">
                    <h3 class="text-white display-4"><span class="text-primary">Coding</span> Academy</h3>
                </div>
