    ...
    <div class="container my-lg-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('coding-school.register.internship.store') }}" method="POST">
                    @csrf
                        <div class="mb-3">
                            <label for="internship_type" class="form-label">Internship Type</label><br>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="internship_type" id="fpe" value="FPE">
                                <label class="form-check-label" for="fpe">First Professional Experience (FPE)</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="internship_type" id="gp" value="GP">
                                <label class="form-check-label" for="gp">Graduation Project (GP)</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="internship_type" id="osc" value="OSC">
                                <label class="form-check-label" for="osc">Orange Summer Challenge (OSC)</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="internship_type" id="other" value="other">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="last_semester" id="yes_last_semester" value="yes">
                                <label class="form-check-label" for="yes_last_semester">Yes</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="last_semester" id="no_last_semester" value="no">
                                <label class="form-check-label" for="no_last_semester">No</label>
                            </div>
                        </div>
                        <!-- Add more fields based on the table -->
