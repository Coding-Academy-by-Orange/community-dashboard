                ...
                <form class="p-4 p-md-5 rounded-3 contact-form" action="{{ route('BigByOrange.store') }}" method="POST">
                    ...
                    @elseif (old('step') == 2)
                        ...
                        <div>
                            ...
                            {{-- LinkedIn Profile --}}
                            <div class="form-group">
                                <label for="linkedin_profile" class="is-required"> LinkedIn Profile<span class="sr-only">
                                        (required)</span></label>
                                <div class="input-group ">
                            ...
                            <div class="form-group">
                                <label for="Female_Co_Founders" class="is-required National_ID">How Many
                                    Female
                                    Co-Founders do you have?
                                    <span class="sr-only"> (required)</span></label>
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="ProvideOfPosition">
                                    <label for="linkedin_profile" class="is-required National_ID">Please
                                        provide
                        ...
                        @elseif (old('step') == 3)
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="Startup" class="is-required"> Please confirm the
                                ...
                                {{-- Startup Name
                                    * --}}
                                <div class="form-group">
                                    <label for="Startup_Name" class="is-required"> Startup Name<span class="sr-only">
                                            (required)</span></label>
                                    <div class="input-group ">
                                ...
                                <div class="form-group">
                                    <label for="describe_your_solution" class="is-required"> Please describe
                                        your
                                    ...
                                    <div class="input-group ">
                                        <input name="describe_your_solution" placeholder="" type="text"
                                            ...
                                            id="describe_your_solution" value="{{ old('describe_your_solution') }}"
                                            required>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="MVP_Demo" class="is-required">This could be in the form of a
                                        link
                                ...
                                {{-- Please confirm the following --}}
                                <div class="form-group">
                                    <label for="Startup" class="is-required"> Where is your startup
                                        registered?
                                        <span class="sr-only"> (required)</span></label>
                                    <div style="margin : 1vw">
                                    ...
                                    <div class="form-group">
                                        <label for="Startup" class="is-required"> What industry'ies' does
                                            your
                                            startup serve?
                                        ...
                                        <div style="margin : 1vw">
                                            ...
                                            <input @if (is_array(old('startup_serve')) && in_array('Digital Fabrication', old('startup_serve'))) checked @endif
                                                name="startup_serve[]" value="Digital Fabrication" type="checkbox">
                                            ...
                                            <input @if (is_array(old('startup_serve')) && in_array('Supply Chain & Logistics', old('startup_serve'))) checked @endif
                                                name="startup_serve[]" value="Supply Chain & Logistics" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div style="margin : 1vw">
                                            ...
                                            <input @if (is_array(old('source_funds')) && in_array('Micro Finance Loans', old('source_funds'))) checked @endif
                                                name="source_funds[]" value="Micro Finance Loans" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <label for="Website" class="is-required"> Could you please elaborate
                                            on
                                        ...
                                        <div class="input-group ">
                                            <input name="amount_of_funds" placeholder="" type="text"
                                                class="form-control" value="{{ old('amount_of_funds') }}" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="Website" class="is-required"> Are you planning to raise
                                            new
                            ...
                            @elseif (old('step') == 4)
                                ...
                                ex: disrupted a certain technology, upgraded the service standard in a certain industry...etc. --}}
                                    <div class="form-group">
                                        <label for="Website" class="is-required"> Please describe the effect
                                            your
                                        ...
                                        <div class="input-group ">
                                            <input name="describe_the_effect" placeholder="" type="text"
                                                class="form-control" value="{{ old('describe_the_effect') }}" required>
                                ...
                                An example could be:  "signing a VAS agreement to sell Orange customers subscriptions for our mobile game" --}}
                                    <div class="form-group">
                                        <label for="Website" class="is-required"> Please describe what
                                            business
                                ...
                                --}}
                                    <div class="form-group">
                                        <label for="Website" class="is-required"> What expectations do you
                                            have
