        ...
        <nav role="navigation" id="mainNav" class="navbar navbar-light bg-white navbar-expand-md pt-2 border-bottom pb-0 mb-2 pt-1"
                ...
                <div class="navbar-collapse justify-content-end collapse" id="orange-navbar-collapse">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link active" style="color: #f16e00 ; border-color : #f16e00" href="{{route('BigByOrange-registration.index')}}">Big By Orange</a></li>
                    </ul>
                    <ul class="navbar-nav">
                        @guest
                    ...
                    <form class="p-4 p-md-5 rounded-3 contact-form" action="{{route('BigByOrange-registration.store')}}" method="POST">
                        ...
                        @if (old('step') == 1)
                            ...
                            <div id="step1" style="display: block">
                                ...
                                <div class="form-group">
                                    <label for="evaluation_purposes" class="is-required">I consent that my data be used for tracking and evaluation purposes<span class="sr-only">(required)</span></label>
                                    <div class="input-group ">

                                        <input style="height:25px; width:25px;" name="evaluation_purposes" value="Yes"  type="radio" class=" email @error('evaluation_purposes') is-invalid @enderror " id="evaluation_purposes" @if(old('evaluation_purposes') == 'Yes') checked @endif required>
                                        <p style="margin-top: 3px ; margin-right : 5vw ; padding-left: 8px">Yes</p>

                                        <input style="height:25px; width:25px;" name="evaluation_purposes" value="No"  type="radio" class="email @error('evaluation_purposes') is-invalid @enderror " id="evaluation_purposes" @if(old('evaluation_purposes') == 'No') checked @endif required>
                        ...
                        {{-- {{dd($errors)}} --}}
                            ...
                            <div>
                                ...
                                {{-- Full Name --}}
                                                        <div class="form-group">
                                                            <label for="First" class="is-required"> Full Name<span
                                ...
                                {{-- LinkedIn Profile --}}
                                        <div class="form-group">
                                            ...
                                            <div class="input-group ">
                                                ...
                                                class="form-control email @error('linkedin_profile') is-invalid @enderror " id="linkedin_profile"
                                                value="{{old('linkedin_profile')}}" required>
                                            </div>
                                ...
                                {{-- Nationality --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group ">
                                                <select name="nationality" class="form-control email @error('nationality') is-invalid @enderror " value="{{old('nationality')}}" required id="nationality" onchange="showIdentification()">
                                                    ...
                                                    <option value="Jordanian" @if(old('nationality') == 'Jordanian') selected @endif>Jordanian</option>
                                                    <option value="NoneJordanian" @if(old('nationality') == 'NoneJordanian') selected @endif>Non-Jordanian</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group National_ID" style="display:none">
                                            <label for="national_id" class="is-required National_ID" style="display:none">National ID #<span
                                                    class="sr-only"> (required)</span></label>
                                            <div class="input-group">
                                                <input name="national_id" type="text" class="form-control email National_ID @error('national_id') is-invalid @enderror " id="national_id" value="{{old('national_id')}}" style="display:none">
                                            </div>
                                        ...
                                        <div class="form-group Passport_No" style="display:none">
                                            <label for="passport_number" class="is-required Passport_No" style="display:none">Refugee ID or Passport No.<span class="sr-only"> (required)</span></label>
                                            <div class="input-group">
                                                <input name="passport_number" type="text" class="form-control email Passport_No @error('passport_number') is-invalid @enderror " id="passport_number" value="{{old('passport_number')}}" style="display:none">
                                            </div>
                                ...
                                {{-- Date of Birth --}}
                                        <div class="form-group">
                                            ...
                                            <label for="birthday" class="is-required">Date of Birth:<span
                                            class="sr-only"> (required)</span></label>

                                            <div class="input-group ">
                                                <input  type="date" id="birthday" name="birthday" required class="form-control email @error('birthday') is-invalid @enderror " value="{{old('birthday')}}">
                                            </div>
                                ...
                                {{-- Gender --}}
                                        <div class="form-group">
                                            <label for="gender" class="is-required">Gender<span
                                                    class="sr-only"> (required)</span></label>
                                            <div class="input-group ">
                                                <input style="height:25px; width:25px;" name="gender" value="Male" required type="radio" class=" email @error('gender') is-invalid @enderror " id="gender" @if(old('gender') == 'Male') checked @endif>
                                                <p style="margin-top: 3px ; margin-right : 5vw ; padding-left: 8px">Male</p>

                                                <input style="height:25px; width:25px;" name="gender" value="Female" required type="radio"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="residence" class="form-control email @error('residence') is-invalid @enderror " id="" required>
                                                    <option value="" selected>-- Please Select --</option>
                                                    <option value="Irbid" @if(old('residence') == 'Irbid') selected @endif>Irbid</option>
                                                    <option value="Ajloun" @if(old('residence') == 'Ajloun') selected @endif>Ajloun</option>
                                                    <option value="Jerash" @if(old('residence') == 'Jerash') selected @endif>Jerash</option>
                                                    <option value="Mafraq" @if(old('residence') == 'Mafraq') selected @endif>Mafraq</option>
                                                    <option value="Balqa" @if(old('residence') == 'Balqa') selected @endif>Balqa</option>
                                                    <option value="Amman" @if(old('residence') == 'Amman') selected @endif>Amman</option>
                                                    <option value="Zarqa" @if(old('residence') == 'Zarqa') selected @endif>Zarqa</option>
                                                    <option value="Madaba" @if(old('residence') == 'Madaba') selected @endif>Madaba</option>
                                                    <option value="Karak" @if(old('residence') == 'Karak') selected @endif>Karak</option>
                                                    <option value="Tafilah" @if(old('residence') == 'Tafilah') selected @endif>Tafilah</option>
                                                    <option value="Ma'an" @if(old('residence') == "Ma'an") selected @endif>Ma'an</option>
                                                    <option value="Aqaba" @if(old('residence') == 'Aqaba') selected @endif>Aqaba</option>
                                                </select>
                                ...
                                {{-- Highest Level of Education Attained --}}
                                        <div class="form-group" style="margin-top: 3vw">
                                            ...
                                            <div>
                                                ...
                                                <input style="margin-top: 15px" name="education" value="Below Tawjihi" required type="radio" class=" @error('education') is-invalid @enderror " @if(old('education') == 'Below Tawjihi') checked @endif>
                                                ...
                                                <input style="margin-top: 15px" name="education" value="Undergraduate" required type="radio"
                                                class="@error('education') is-invalid @enderror "
                                ...
                                {{-- Employment Status --}}
                                    <div class="form-group" style="margin-top: 3vw">
                                        ...
                                        <div>
                                            ...
                                            <input style="margin-top: 15px" name="employment" value="Part-Time" required type="radio" class=" @error('employment') is-invalid @enderror " @if(old('employment') == 'Part-Time') checked @endif>
                                            ...
                                            <input style="margin-top: 15px" name="employment" value="Self-Employed" required type="radio"
                                            class=" @error('employment') is-invalid @enderror "
                                    ...
                                    <div class="form-group">
                                        <label for="person_with_disability" class="is-required">Are you a person with disability?
                                        *
                                        Persons with disabilities include those who have long-term physical, mental, intellectual or sensory impairments which in interaction with various barriers may hinder their full and effective participation in society on an equal basis with others.<span
                                            class="sr-only"> (required)</span></label>
                                        <div>

                                            <input  name="person_with_disability" value="Yes" required type="radio" class=" @error('person_with_disability') is-invalid @enderror "@if(old('person_with_disability') == 'Yes') checked @endif>
                                           ...
                                           @if(old('person_with_disability') == 'No') checked @endif>
                                            ...
                                            <input  name="person_with_disability" value="I_do_not_wish_to_answer" required type="radio"
                                            class=" @error('person_with_disability') is-invalid @enderror "
                                    ...
                                    <div class="form-group">
                                        <label for="Male_Co_Founders" class="is-required National_ID">How Many Male Co-Founders do you have?
                                            <span class="sr-only"> (required)</span></label>
                                        <div class="input-group">
                                            <input name="Male_Co_Founders" type="number" class="form-control email National_ID @error('Male_Co_Founders') is-invalid @enderror " id="Male_Co_Founders" value="{{old('Male_Co_Founders')}}" >
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="Female_Co_Founders" class="is-required National_ID">How Many Female Co-Founders do you have?
                                            <span class="sr-only"> (required)</span></label>
                                        <div class="input-group">
                                            <input name="Female_Co_Founders" type="number" class="form-control email National_ID @error('Female_Co_Founders') is-invalid @enderror " id="Female_Co_Founders" value="{{old('Female_Co_Founders')}}" >
                                        </div>
                                ...
                                {{-- Your Position in the Startup --}}
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <input  name="Position" value="CEO" required type="radio" class=" @error('Position') is-invalid @enderror " @if(old('Position') == 'CEO') checked @endif>
                                ...
                                {{-- Please provide the positions held by your co-founders and their LinkedIn profiles --}}
                                    <div class="ProvideOfPosition" >
                                        <label for="linkedin_profile" class="is-required National_ID" >Please provide the positions held by your co-founders and their LinkedIn profiles<span class="sr-only"> (required)</span></label>
                                        <div class="input-group">
                                            <input name="ProvideOfPosition" type="text" class="form-control email National_ID @error('ProvideOfPosition') is-invalid @enderror " id="ProvideOfPosition" value="{{old('ProvideOfPosition')}}" >
                                        </div>
                        ...
                        @elseif (old('step') == 3)
                            ...
                            <input type="hidden" name="step" value="3">
                                <div class="form-group">
                                    <h4>Startup</h4>
                                    <p>In this section, please provide accurate information about the startup you are applying with to BIG by Orange</p>
                                    ...
                                    <div style="margin : 1vw">
                                        ...
                                        <input  name="Startup[]" value="Startup is based in or operates from Jordan" type="checkbox" @if(is_array(old('Startup')) && in_array('Startup is based in or operates from Jordan', old('Startup'))) checked @endif>
                                        <span style="margin-top: 1vw">Startup is based in or operates from Jordan</span>
                                        <br>

                                        <input  name="Startup[]" value="Startup has at least 1 Jordanian founder" type="checkbox" @if(is_array(old('Startup')) && in_array('Startup has at least 1 Jordanian founder', old('Startup'))) checked @endif>
                                        <span style="margin-top: 1vw">Startup has at least 1 Jordanian founder
                                        </span>
                                        <br>

                                        <input onchange="showChossenProgramming()" name="Startup[]" class="@error('programming') is-invalid @enderror" @if(is_array(old('Startup')) && in_array('Other exercises', old('Startup'))) checked @endif value="Other exercises" type="checkbox">
                                    ...
                                    * --}}
                                    ...
                                    <div class="input-group ">
                                        ...
                                        class="form-control email @error('Startup_Name') is-invalid @enderror " id="Startup_Name"
                                    ...
                                    * --}}
                                    <div class="form-group">
                                    <label for="Website" class="is-required"> Website<span
                                        class="sr-only"> (required)</span></label>
                                    <div class="input-group ">
                                    ...
                                    * --}}
                                    ...
                                    <div class="input-group ">
                                        ...
                                        class="form-control email @error('Social_Media') is-invalid @enderror " id="Social_Media"
                                        value="{{old('Social_Media')}}" required>
                                    </div>
                                    ...
                                    * --}}
                                    <div class="form-group">
                                    <label for="problem_your_startup" class="is-required"> Please describe the need/problem your startup is trying to satisfy/solve<span
                                        class="sr-only"> (required)</span></label>
                                    <div class="input-group ">
                                        <input name="problem_your_startup" placeholder="" type="text"
                                        class="form-control email @error('problem_your_startup') is-invalid @enderror " id="problem_your_startup"
                                        value="{{old('problem_your_startup')}}" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                    <label for="describe_your_solution" class="is-required"> Please describe your solution<span
                                        class="sr-only"> (required)</span></label>
                                    <div class="input-group ">
                                        <input name="describe_your_solution" placeholder="" type="text"
                                        class="form-control email @error('describe_your_solution') is-invalid @enderror " id="describe_your_solution"
                                    ...
                                    <label for="MVP_Demo" class="is-required">This could be in the form of a link to your MVP application or platform, or to a video of your hardware MVP in action
                                        ASdDad
                                        <span
                                        class="sr-only"> (required)</span></label>
                                    <div class="input-group ">
                                    ...
                                    <div style="margin : 1vw">
                                        ...
                                        <input @if(is_array(old('startup_registered')) && in_array('Jordan', old('startup_registered'))) checked @endif name="startup_registered[]" value="Jordan" type="checkbox" >
                                        <span style="margin-top: 1vw">Jordan</span>
                                        <br>

                                        <input @if(is_array(old('startup_registered')) && in_array('GCC', old('startup_registered'))) checked @endif name="startup_registered[]" value="GCC" type="checkbox">
                                        <span style="margin-top: 1vw">GCC</span>
                                        <br>

                                        <input @if(is_array(old('startup_registered')) && in_array('Europe', old('startup_registered'))) checked @endif name="startup_registered[]" value="Europe" type="checkbox" >
                                        <span style="margin-top: 1vw">Europe</span>
                                        <br>

                                        <input @if(is_array(old('startup_registered')) && in_array('BVI', old('startup_registered'))) checked @endif name="startup_registered[]" value="BVI" type="checkbox">
                                        <span style="margin-top: 1vw">BVI</span>
                                        <br>

                                        <input @if(is_array(old('startup_registered')) && in_array('North America', old('startup_registered'))) checked @endif name="startup_registered[]" value="North America" type="checkbox" >
                                        <span style="margin-top: 1vw">North America</span>
                                        <br>

                                        <input @if(is_array(old('startup_registered')) && in_array('Not Registered', old('startup_registered'))) checked @endif name="startup_registered[]" value="Not Registered" type="checkbox">
                                    ...
                                    --}}
                                    <div class="form-group">
                                    <label for="Website" class="is-required"> What is your startup's registration number?
                                        <span
                                        class="sr-only"> (required)</span></label>
                                    <div class="input-group ">
                                        <input name="registration_number" placeholder="" type="text"
                                        class="form-control email @error('registration_number') is-invalid @enderror " id="registration_number"
                                    ...
                                    <div class="form-group">
                                    <label for="Startup" class="is-required"> What industry'ies' does your startup serve?

                                        <span
                                        class="sr-only"> (required)</span></label>
                                    <div style="margin : 1vw">

                                        <input @if(is_array(old('startup_serve')) && in_array('E-commerce', old('startup_serve'))) checked @endif name="startup_serve[]" value="E-commerce" type="checkbox">
                                        ...
                                        <input @if(is_array(old('startup_serve')) && in_array('Other exercises', old('startup_serve'))) checked @endif class="@error('programming') is-invalid @enderror " value="Other exercises" type="checkbox">
                                        <span style="margin-top: 1vw">Other</span>
                                        <br>
                                    ...
                                    <div class="input-group ">
                                        ...
                                        class="form-control" value="{{old('Funds')}}"
                                        required>
                                    </div>
                                    @if ($errors->has('Funds'))
                                    <div class="alert alert-danger">
                                    ...
                                    <div style="margin : 1vw">
                                        ...
                                        <input @if(is_array(old('source_funds')) && in_array('Personal Funds', old('source_funds'))) checked @endif name="source_funds[]" value="Personal Funds" type="checkbox" >
                                        <span style="margin-top: 1vw">Personal Funds
                                        </span>
                                        <br>

                                        <input @if(is_array(old('source_funds')) && in_array('Friends & Family', old('source_funds'))) checked @endif name="source_funds[]" value="Friends & Family" type="checkbox">
                                        <span style="margin-top: 1vw">Friends & Family</span>
                                        <br>

                                        <input @if(is_array(old('source_funds')) && in_array('Personal Loans', old('source_funds'))) checked @endif name="source_funds[]" value="Personal Loans" type="checkbox" >
                                        <span style="margin-top: 1vw">Personal Loans
                                        </span>
                                        <br>

                                        <input @if(is_array(old('source_funds')) && in_array('Business Loans', old('source_funds'))) checked @endif name="source_funds[]" value="Business Loans" type="checkbox">
                                        <span style="margin-top: 1vw">Business Loans
                                        </span>
                                        <br>

                                        <input @if(is_array(old('source_funds')) && in_array('Micro Finance Loans', old('source_funds'))) checked @endif name="source_funds[]" value="Micro Finance Loans" type="checkbox" >
                                        <span style="margin-top: 1vw">Micro Finance Loans
                                        </span>
                                        <br>

                                        <input @if(is_array(old('source_funds')) && in_array('Grants', old('source_funds'))) checked @endif name="source_funds[]" value="Grants" type="checkbox">
                                        <span style="margin-top: 1vw">Grants</span>
                                        <br>

                                        <input @if(is_array(old('source_funds')) && in_array('Angel Investors', old('source_funds'))) checked @endif name="source_funds[]" value="Angel Investors" type="checkbox">
                                        <span style="margin-top: 1vw">Angel Investors</span>
                                        <br>

                                        <input @if(is_array(old('source_funds')) && in_array('Venture Capital', old('source_funds'))) checked @endif name="source_funds[]" value="Venture Capital" type="checkbox">
                                        <span style="margin-top: 1vw">Venture Capita</span>
                                        <br>

                                        <input  name="source_funds[]" value="None" type="checkbox" @if(is_array(old('source_funds')) && in_array('None', old('source_funds'))) checked @endif>
                                    ...
                                    <div class="form-group">
                                    <label for="Website" class="is-required"> Could you please elaborate on the amount of funds raised from each sources?
                                        If None, please write N/A
                                        <span
                                        class="sr-only"> (required)</span></label>
                                    <div class="input-group ">
                                    ...
                                    <div class="form-group">
                                    <label for="Website" class="is-required"> Are you planning to raise new funds over the next year? If yes, please elaborate on what type of funds are you looking for
                                        This includes: Grants, VC Investments, Angel Investments, Venture Debt, Loans, ...etc.
                                        <span
                                        class="sr-only"> (required)</span></label>
                                    <div class="input-group ">
                                        <input name="new_funds" placeholder="" type="text"
                                        class="form-control" value="{{old('new_funds')}}"
                                        required>
                                    ...
                                    <div class="form-group">
                                    <label for="markets" class="is-required"> Markets currently served by your startup

                                        <span
                                        class="sr-only"> (required)</span></label>
                                    <div style="margin : 1vw">

                                        <input name="markets[]" @if(is_array(old('markets')) && in_array('Jordan', old('markets'))) checked @endif value="Jordan" type="checkbox" >
                                        <span style="margin-top: 1vw">Jordan
                                        </span>
                                        <br>

                                        <input name="markets[]" @if(is_array(old('markets')) && in_array('GCC', old('markets'))) checked @endif value="GCC" type="checkbox">
                                        <span style="margin-top: 1vw">GCC</span>
                                        <br>
                                        <input name="markets[]" @if(is_array(old('markets')) && in_array('North Africa', old('markets'))) checked @endif value="North Africa" type="checkbox" >
                                        <span style="margin-top: 1vw">North Africa</span>
                                        <br>

                                        <input name="markets[]" @if(is_array(old('markets')) && in_array('Africa', old('markets'))) checked @endif value="Africa" type="checkbox">
                                        <span style="margin-top: 1vw">Africa</span>
                                        <br>
                                        <input name="markets[]" @if(is_array(old('markets')) && in_array('India', old('markets'))) checked @endif value="India" type="checkbox" >
                                        <span style="margin-top: 1vw">India</span>
                                        <br>

                                        <input name="markets[]" @if(is_array(old('markets')) && in_array('Rest of Asia', old('markets'))) checked @endif value="Rest of Asia" type="checkbox">
                                        <span style="margin-top: 1vw">Rest of Asia</span>
                                        <br>

                                        <input name="markets[]" @if(is_array(old('markets')) && in_array('Europe', old('markets'))) checked @endif value="Europe" type="checkbox">
                                        <span style="margin-top: 1vw">Europe</span>
                                        <br>
                                        <input name="markets[]" @if(is_array(old('markets')) && in_array('Oceania', old('markets'))) checked @endif value="Oceania" type="checkbox">
                                        <span style="margin-top: 1vw">Oceania</span>
                                        <br>
                                        <input name="markets[]" @if(is_array(old('markets')) && in_array('South America', old('markets'))) checked @endif value="South America" type="checkbox">
                                        <span style="margin-top: 1vw">South America</span>
                                        <br>
                                        <input name="markets[]" @if(is_array(old('markets')) && in_array('Central America', old('markets'))) checked @endif value="Central America" type="checkbox">
                                        <span style="margin-top: 1vw">Central America</span>
                                        <br>

                                        <input name="markets[]" @if(is_array(old('markets')) && in_array('North America', old('markets'))) checked @endif value="North America"type="checkbox"
                                        >
                                        <span style="margin-top: 1vw">North America
                                        </span>
                                        <br>
                                        <input class="@error('programming') is-invalid @enderror " value="Other exercises" type="checkbox" @if(is_array(old('markets')) && in_array('Other exercises', old('markets'))) checked @endif
                                        >
                                        <span style="margin-top: 1vw">Other</span>
                                        <br>
                                    </div>
                                    ...
                                    <div class="form-group">
                                    <label for="revenue" class="is-required"> How much revenue have you generated to date
                                        <span
                                        class="sr-only"> (required)</span></label>
                                    <div class="input-group ">
                                        <input name="revenue" placeholder="" type="text"
                                        class="form-control" value="{{old('revenue')}}"
                                        required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                    <label for="milestones_and_achievements" class="is-required"> Please describe key milestones and achievements you have achieved to date
                                        <span
                                        class="sr-only"> (required)</span></label>
                                    <div class="input-group ">
                                        <input name="milestones_and_achievements" placeholder=""  type="text"
                                        class="form-control" value="{{old('milestones_and_achievements')}}"
                                        required>
                                    </div>
                        ...
                        @elseif (old('step') == 4)
                            ...
                            <div class="form-group">
                               {{-- _________________________________ page 4________________________________________ --}}
                                ...
                                <div class="form-group">
                                <label for="Website" class="is-required"> Please describe the effect your product/service have had/could have on the markets you operate in
                                    ex: disrupted a certain technology, upgraded the service standard in a certain industry...etc.
                                    <span
                                    class="sr-only"> (required)</span></label>
                                <div class="input-group ">
                                ...
                                <div class="form-group">
                                <label for="Website" class="is-required"> Please describe what business opportunities you anticipate having with Orange Jordan?
                                    An example could be:  "signing a VAS agreement to sell Orange customers subscriptions for our mobile game"
                                    <span
                                    class="sr-only"> (required)</span></label>
                                <div class="input-group ">
                                ...
                                <div class="form-group">
                                <label for="Website" class="is-required"> Please specify units and/or departments at Orange Jordan that you wish to do business with
                                    <span
                                    class="sr-only"> (required)</span></label>
                                <div class="input-group ">
                                    <input name="specify_units" placeholder="" type="text"
                                    class="form-control" value="{{old('specify_units')}}"
                                    required>
                                ...
                                --}}
                                <div class="form-group">
                                <label for="Website" class="is-required"> What expectations do you have from joining BIG by Orange?

                                    <span class="sr-only"> (required)</span></label>
                                <div class="input-group ">
                                    <input name="expectations" placeholder="" type="text"
                                    class="form-control" value="{{old('expectations')}}"
                                    required>
                                ...
                                <div class="form-group">
                                <label for="consent_to_receiving" class="is-required">I consent to receiving regular e-mails from Orange's newsletter</label>
                                <div class="input-group ">
                                    <input style="height:25px; width:25px;" name="consent_to_receiving" value="Yes" required type="radio" class=" email @error('gender') is-invalid @enderror " id="consent_to_receiving" @if(old('consent_to_receiving') == 'Yes') checked @endif>
                                    <p style="margin-top: 3px ; margin-right : 5vw ; padding-left: 8px">Yes</p>

                                    <input style="height:25px; width:25px;" name="consent_to_receiving" value="No" required type="radio"
                                    class="email @error('gender') is-invalid @enderror " id="consent_to_receiving"
                        ...
                        @else
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    <label for="evaluation_purposes" class="is-required">I consent that my data be used for tracking and evaluation purposes
                                    <span
                                            class="sr-only"> (required)</span></label>
                                    <div class="input-group ">
                                        <input style="height:25px; width:25px;" name="evaluation_purposes" value="yes"  type="radio" class=" email @error('gender') is-invalid @enderror " id="gender" value="{{old('gender')}}">
                                        <p style="margin-top: 3px ; margin-right : 5vw ; padding-left: 8px">Yes</p>

                                        <input style="height:25px; width:25px;" name="evaluation_purposes" value="no"  type="radio"
                                        class="email @error('gender') is-invalid @enderror " id="gender"
                                        value="{{old('gender')}}">
                                        <p style="margin-top: 3px; padding-left: 8px">No</p>
                                    </div>
