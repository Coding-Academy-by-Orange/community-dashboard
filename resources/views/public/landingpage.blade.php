    ...
    <body>
        ...
        <nav role="navigation" id="mainNav" class="navbar navbar-light bg-white navbar-expand-md pt-2 border-bottom pb-0 mb-2 pt-1"
                ...
                <div class="navbar-collapse justify-content-end collapse" id="orange-navbar-collapse">
                    <ul class="navbar-nav">
                        <li class="nav-item"><a class="nav-link active"  style="color: #f16e00 ; border-color : #f16e00" href="/">Home </a></li>
        ...
        <div class="container">
            <div class="row align-items-center g-lg-5 py-5 d-flex" style="justify-content: space-around">
                <div class="card" style="width: 20rem; height: 25rem">
                    ...
                    <img class="card-img-top" width="150" height="120" src="https://boosted.orange.com/docs/5.2/assets/brand/orange-logo.svg" alt="Card image cap">
                    </a>
                    <div class="card-body">
                        <a href="/codingacademy" style="text-decoration: none">
                        ...
                        <a href="/codingacademy" style="text-decoration: none">
                        <p class="card-text" style="margin-top : 20px">The Coding Academy by Orange was launched in June 2019, in partnership with Simplon.co, to offer a free of charge 6-month training courses in coding languages for free, supported by 1-month internship in ICT sector.</p>
                    </a>
                    </div>
                ...
                <div class="card" style="width: 20rem;height: 25rem">
                    ...
                    <div class="card-body">
                        ...
                        <a href="/fablab-registration" style="text-decoration: none">
                        <p class="card-text" style="margin-top : 20px">The Fab Lab is a space dedicated towards teaching students the art of digital fabrication along with the accompanying design philosophies. </p>
                        </a>
                    </div>
                ...
                <div class="card" style="width: 20rem;height: 25rem">
                    ...
                    <div class="card-body">
                        <a href="/ODC" style="text-decoration: none">
                        <h5 class="card-title" style="text-align: center">Digital Centers</h5>
                        </a>
                        <a href="/ODC" style="text-decoration: none">
                        <p class="card-text" style="margin-top : 20px">Orange Digital Center houses four strategic programs under the same roof : the coding school, the FabLab Solidaire, Orange Fab and Orange Digital Ventures Africa</p>
                        </a>
                    </div>
                ...
                <div class="card" style="width: 20rem;height: 25rem">
                    ...
                    <img class="card-img-top" src="https://boosted.orange.com/docs/5.2/assets/brand/orange-logo.svg" width="150" height="120" alt="Card image cap">
                    </a>
                    <div class="card-body">
                        <a href="{{route('BigByOrange-registration.index')}}" style="text-decoration: none">
