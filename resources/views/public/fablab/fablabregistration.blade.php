        ...
        <nav role="navigation" id="mainNav" class="navbar navbar-light bg-white navbar-expand-md pt-2 border-bottom pb-0 mb-2 pt-1"
                ...
                <div class="navbar-collapse justify-content-end collapse" id="orange-navbar-collapse">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link active" style="color: #f16e00 ; border-color : #f16e00" href="/fablab-registration">Fablab</a></li>
        ...
        <div class="container">
            <div class="row align-items-center g-lg-5 py-5">
                <div class="col-8 mx-auto">
                    ...
                    @endif
                    <form class="p-4 p-md-5 rounded-3" action="{{route('fablab-registration.store')}}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group ">
                                <input style="margin-right : 10px ; margin-bottom : 10px" name="first_name" placeholder="First Name" type="text"
                            ...
                            <div class="input-group ">
                                <input style="margin-right : 10px ; margin-bottom : 10px" name="grandfather_name" placeholder="Grandfather's Name" type="text"
                        ...
                        <div class="form-group">
                            <label for="age" class="is-required">Age<span
                                    class="sr-only"> (required)</span></label>
                            <div class="input-group ">
                                <input  name="age" required type="text"class="form-control email @error('age') is-invalid @enderror " id="age"value="{{old('age')}}">
                            </div>
                            @if ($errors->has('age'))
                            <div class="alert alert-danger">
                                {{ $errors->first('age') }}
                        ...
                        <div class="form-group">
                            <label for="whatsapp" class="is-required">Whatsapp Number<span class="sr-only"> (required)</span></label>
                            <div class="input-group ">
                        ...
                        <div class="form-group" style="margin-top: 3vw">
                            <label for="program" class="is-required">Choose the program you wish to join<span
                                class="sr-only"> (required)</span></label>
                            <div>
                                <input style="margin-top: 15px" name="program" value="Innovators in Residence (IIRs)" required type="radio" class=" @error('program') is-invalid @enderror " @if(old('program') == 'Innovators in Residence (IIRs)') checked @endif>
                        ...
                        <div class="form-group" style="margin-top: 3vw">
                            ...
                            <div class="input-group ">
                                <textarea style="height: 10vw" name="idea_description" type="text" class="form-control mobile @error('idea_description') is-invalid @enderror " id="idea_description" required>{{ old('idea_description') }}</textarea>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input @error('chAgree') is-invalid @enderror" id="chAgree"
                                       name="chAgree" type="checkbox" @if(old('chAgree')) checked @endif required>
