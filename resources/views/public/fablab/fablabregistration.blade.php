        ...
        <div class="container position-relative z-0">
            <div class="row pt-3 px-5">
                <div class="col-5 pt-5 z-1">
                    <h1 class="pt-1 pt-md-4 mb-2 mb-md-3 display-3 text-primary">FabLab</h1>
                    <h2 class="display-4 text-white">Innovate, Create, Fabricate</h2>
                    <p class="ll-sm pt-1 mb-3">FabLab is a space dedicated to teaching students the art of digital fabrication along with the accompanying design philosophies from Orange Jordan. Join us to explore the world of digital manufacturing and bring your ideas to life.</p>
                    <a href="{{ route('fablab.create') }}" class="btn btn-primary">Register Now</a>
                </div>
        ...
        <div class="container py-5">
            <div class="row d-flex">
                <div class="col-4 align-self-md-center">
                    <h3 class="text-white display-4"><span class="text-primary">Fab</span> Lab</h3>
                </div>
