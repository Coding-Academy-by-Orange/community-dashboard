                        ...
                        <fieldset class="wizard-fieldset show col-lg-10 col-md-12 ml-md-4 ">
                            <form class="personal-info-step1" action="javascript:void(0)">
                                            ...
                                            <div class="mb-1 form-group">
                                                ...
                                                <select name="educational_level" class="custom-select wizard-required"
                                                    ...
                                                    <option value="bachelor"
                                                        @if ($user->education == 'bachelor') selected @endif>
                                                        Bachelor
                                                    </option>
                                                    <option value="master_degree"
                                                        @if ($user->educationa == 'master_degree') selected @endif>
                                                        Master degree
                                                    </option>
                                                    <option value="ph.D."
                                                        @if ($user->education == 'ph.D.') selected @endif>Ph.D. </option>

                                                    <option value="diploma"
                                                        @if ($user->education == 'diploma') selected @endif>
                                                        Diploma
                                                    </option>
                                                    <option value="high_diploma"
                                                        @if ($user->education == 'high_diploma') selected @endif>
                                                        High Diploma
                                                    </option>
                                                    <option value="high_school"
                                                        @if ($user->education == 'high_school') selected @endif>
                                                        High School
                                                    </option>
                                                </select>
                                            </div>
                                    ...
                                    <fieldset class="form-group col-lg-12 px-0 my-4">
                                        ...
                                        <div class="ml-2">
                                            <div id="radio-action" class="form-inline d-flex ">
                                                <div
                                                    class="custom-control custom-radio custom-control-inline wizard-form-radio"style="margin-right:250px">
                                                    <input type="radio" name="educational_status" value="graduated"
                                                        id="graduated" class="custom-control-input" autocomplete="off"
                                                        {{ $user->educational_status == 'graduated' ? 'checked' : '' }}>
                                                    <label class="custom-control-label " for="graduated">Graduated </label>
                                                </div>
                                                <div
                                                    class="custom-control custom-radio custom-control-inline wizard-form-radio">
                                                    <input type="radio" name="educational_status" value="under_graduate"
                                                        id="under-graduate" class="custom-control-input" autocomplete="off"
                                                        {{ $user->educational_status == 'under_graduate' ? 'checked' : '' }}>
                                                    <label class="custom-control-label " for="under-graduate">Under
                                                        Graduate</label>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div id="radio-action" class="form-inline d-flex">
                                                <div class="custom-control custom-radio custom-control-inline wizard-form-radio"
                                                    ...
                                                    <input type="radio" name="educational_background"
                                                        value="it_background" id="it-background"
                                                        class="custom-control-input" autocomplete="off"
                                                        {{ $user->educational_background == 'it_background' ? 'checked' : '' }}>
                                                    <label class="custom-control-label " for="it-background"
                                                        style="white-space:nowrap">IT background</label>
                                                </div>
                                                <div
                                                    class="custom-control custom-radio custom-control-inline wizard-form-radio">
                                                    <input type="radio" name="educational_background"
                                                        ...
                                                        class="custom-control-input" autocomplete="off"
                                                        {{ $user->educational_background == 'non_it_background' ? 'checked' : '' }}>
                                ...
                                <div class=" col-md-12  d-flex justify-content-end mt-5 px-0">
                                    <div class="ml-3">
                                        <a class="Go1 btn btn-sm-block btn-secondary   personal_info_save1"
                                            href="{{ route('client.dashboard') }}" type="submit">Go Home
                                        </a>
                                    </div>
                                    <div class="ml-3  ">
                                        <button
                                            class="btn1 btn btn-sm-block border form-wizard-next-btn  personal_info_save1"
                        ...
                        <fieldset class=" wizard-fieldset col-lg-10 col-md-12 ml-md-5 ">
                            <form class="personal-info-step2 " action="javascript:void(0)">
                                        ...
                                        <div id="radio-action " required
                                            ...
                                            <div
                                                ...
                                                <input type="radio" name="ar_writing" value="poor"
                                                    id="ar_writing_poor" class="custom-control-input ar_writing1"
                                                    autocomplete="off"
                                                    {{ $user->ar_writing == 'poor' ? 'checked' : '' }}>
                                                <label class="custom-control-label " for="ar_writing_poor">Poor</label>
                                            </div>
                                            <div
                                                class="custom-control custom-radio custom-control-inline wizard-form-radio">
                                                <input type="radio" name="ar_writing" value="good"
                                                    id="ar_writing_good" class="custom-control-input ar_writing2"
                                                    autocomplete="off"
                                                    {{ $user->ar_writing == 'good' ? 'checked' : '' }}>
                                                <label class="custom-control-label " for="ar_writing_good">Good</label>
                                            </div>
                                            <div
                                                class="custom-control custom-radio custom-control-inline wizard-form-radio">
                                                <input type="radio" name="ar_writing" value="very_good"
                                                    id="ar_writing_very_good" class="custom-control-input ar_writing3"
                                                    autocomplete="off"
                                                    {{ $user->ar_writing == 'very_good' ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="ar_writing_very_good">Very
                                                    good</label>
                                            </div>
                                            <div
                                                class="custom-control custom-radio custom-control-inline wizard-form-radio">
                                                <input type="radio" name="ar_writing" value="fluent"
                                                    id="ar_writing_fluent" class="custom-control-input ar_writing4"
                                                    autocomplete="off"
                                                    {{ $user->ar_writing == 'fluent' ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="ar_writing_fluent">Fluent</label>
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset class="form-group col-8">
                                        ...
                                        <div id="radio-action" class="form-inline d-flex justify-content-between">
                                            <div
                                                ...
                                                <input type="radio" name="ar_speaking" value="poor"
                                                    id="ar_speaking_poor" class="custom-control-input ar_speaking1"
                                                    autocomplete="off"
                                                    {{ $user->ar_speaking == 'poor' ? 'checked' : '' }}>
                                                <label class="custom-control-label " for="ar_speaking_poor">Poor</label>
                                            </div>
                                            <div
                                                class="custom-control custom-radio custom-control-inline wizard-form-radio">
                                                <input type="radio" name="ar_speaking" value="good"
                                                    id="ar_speaking_good" class="custom-control-input ar_speaking2"
                                                    autocomplete="off"
                                                    {{ $user->ar_speaking == 'good' ? 'checked' : '' }}>
                                                <label class="custom-control-label " for="ar_speaking_good">Good</label>
                                            </div>
                                            <div
                                                class="custom-control custom-radio custom-control-inline wizard-form-radio">
                                                <input type="radio" name="ar_speaking" value="very_good"
                                                    id="ar_speaking_very_good" class="custom-control-input ar_speaking3"
                                                    autocomplete="off"
                                                    {{ $user->ar_speaking == 'very_good' ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="ar_speaking_very_good">Very
                                                    good</label>
                                            </div>
                                            <div
                                                class="custom-control custom-radio custom-control-inline wizard-form-radio">
                                                <input type="radio" name="ar_speaking" value="fluent"
                                                    id="ar_speaking_fluent" class="custom-control-input ar_speaking4"
                                                    autocomplete="off"
                                                    {{ $user->ar_speaking == 'fluent' ? 'checked' : '' }}>
                                        ...
                                        <div id="radio-action" class="form-inline d-flex justify-content-between">
                                            <div
                                                ...
                                                <input type="radio" name="en_writing" value="poor"
                                                    id="en_writing_poor" class="custom-control-input" autocomplete="off"
                                                    {{ $user->en_writing == 'poor' ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="en_writing_poor">Poor</label>
                                            </div>
                                            <div
                                                class="custom-control custom-radio custom-control-inline wizard-form-radio">
                                                <input type="radio" name="en_writing" value="good"
                                                    id="en_writing_good" class="custom-control-input" autocomplete="off"
                                                    {{ $user->en_writing == 'good' ? 'checked' : '' }}>
                                                <label class="custom-control-label " for="en_writing_good">Good</label>
                                            </div>
                                            <div
                                                class="custom-control custom-radio custom-control-inline wizard-form-radio">
                                                <input type="radio" name="en_writing" value="very_good"
                                                    id="en_writing_very_good" class="custom-control-input"
                                                    autocomplete="off"
                                                    {{ $user->en_writing == 'very_good' ? 'checked' : '' }}>
                                                <label class="custom-control-label " for="en_writing_very_good">Very
                                                    good</label>
                                            </div>
                                            <div
                                                class="custom-control custom-radio custom-control-inline wizard-form-radio">
                                                <input type="radio" name="en_writing" value="fluent"
                                                    id="en_writing_fluent" class="custom-control-input"
                                                    autocomplete="off"
                                                    {{ $user->en_writing == 'fluent' ? 'checked' : '' }}>
                                                <label class="custom-control-label "
                                        ...
                                        <div id="radio-action" class="form-inline d-flex justify-content-between">
                                            <div
                                                ...
                                                <input type="radio" name="en_speaking" value="poor"
                                                    id="en_speaking_poor" class="custom-control-input "
                                                    autocomplete="off"
                                                    {{ $user->en_speaking == 'poor' ? 'checked' : '' }}>
                                            ...
                                            <div
                                                ...
                                                <input type="radio" name="en_speaking" value="good"
                                                    id="en_speaking_good" class="custom-control-input en_speaking2"
                                                    autocomplete="off"
                                                    {{ $user->en_speaking == 'good' ? 'checked' : '' }}>
                                                <label class="custom-control-label " for="en_speaking_good">Good</label>
                                            </div>
                                            <div
                                                class="custom-control custom-radio custom-control-inline wizard-form-radio">
                                                <input type="radio" name="en_speaking" value="very_good"
                                                    id="en_speaking_very_good" class="custom-control-input en_speaking3"
                                                    autocomplete="off"
                                                    {{ $user->en_speaking == 'very_good' ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="en_speaking_very_good">Very
                                                    good</label>
                                            </div>
                                            <div
                                                class="custom-control custom-radio custom-control-inline wizard-form-radio">
                                                <input type="radio" name="en_speaking" value="fluent"
                                                    id="en_speaking_fluent" class="custom-control-input en_speaking4"
                                                    autocomplete="off"
                                                    {{ $user->en_speaking == 'fluent' ? 'checked' : '' }}>
                                                <label class="custom-control-label"
                                ...
                                <div class="btncen d-flex justify-content-between col-12  pl-0">
                                    <button class="form-wizard-previous-btn mr-4 justify-content-rounded btn btn-secondary"
                                        type="button">Previous
                                    </button>
                                    <div class="d-flex justify-content-end">
                                        <a class="Go1 btn btn-sm-block btn-secondary mr-2 ml-2 personal_info_save1"
                                            href="{{ route('client.dashboard') }}" type="submit">Go Home
                                        </a>
                                        <button
                            ...
                            <form class="personal-info-step3" action="javascript:void(0)">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <select class="custom-select wizard-required" id="city" required
                                            name="city">
                                            <option value="">
                                                Select..
                                            </option>
                                            <option value="Irbid" @if ($user->city == 'Irbid') selected @endif>Irbid
                                            </option>
                                            <option value="Ajloun" @if ($user->city == 'Ajloun') selected @endif>Ajloun
                                            </option>
                                            <option value="Jerash" @if ($user->city == 'Jerash') selected @endif>Jerash
                                            </option>
                                            ...
                                            <option value="Zarqa" @if ($user->city == 'Zarqa') selected @endif>
                                                Zarqa
                                            </option>
                                            ...
                                            <option value="Ma'an" @if ($user->city == "Ma'an") selected @endif>
                                                Ma'an
                                            </option>
                                    ...
                                    <div class="form-group col-sm-6 ">
                                        ...
                                        <input type="text" name="address" id="address"
                                            ...
                                            placeholder="eg: Amman, Jubaiha, Jubran St., Building 13 "
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <select name="know_us" required="" class="custom-select wizard-required"
                                            id="PostCategoryId">
                                            <option value="Select..">
                                                Select..
                                            </option>
                                ...
                                <div class="btncen2 d-flex justify-content-between mt-5 col-12 pl-0">
                                    <button class="form-wizard-previous-btn  mr-4 btn btn-secondary"
                                        type="button">Previous
                                    </button>
                                    <div class=" d-flex justify-content-end">
                                        <a class="Go1 btn btn-sm-block btn-secondary mr-2 ml-2 personal_info_save1"
                                        ...
                                        <button class="form-wizard-next-btn border btn personal_info_save3"
                                            type="submit">Save & Continue
                                        </button>
                                    </div>
                                </div>
                            ...
                            <form class="personal-info-step4" method="post"
                                ...
                                <div class="row mt-4">
                                    <div class="form-group col-sm-12 ">
                                        ...
                                        <input type="text" name="fullName_1" id="fullName_1" required
                                            class="form-control wizard-required"
                                            value="@if ($user->fullName_1) {{ $user->fullName_1 }} @endif">
                                    </div>
                                    <div class="form-group col-sm-6">
                                        ...
                                        <select name="relative_relation_1" required class="custom-select wizard-required"
                                            ...
                                            <option value="father" @if ($user->relative_relation_1 == 'father') selected @endif>
                                                Father
                                            </option>
                                            <option value="mother" @if ($user->relative_relation_1 == 'mother') selected @endif>
                                                Mother
                                            </option>
                                            <option value="brother" @if ($user->relative_relation_1 == 'brother') selected @endif>
                                                Brother
                                            </option>
                                            <option value="sister" @if ($user->relative_relation_1 == 'sister') selected @endif>
                                                Sister
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group col-sm-6 ">
                                        <label for="relative_mobile" class="is-required">Mobile
                                            Number</label>
                                        <input name="relative_mobile_1" type="number"
                                            class="form-control wizard-required" id="relative_mobile" required
                                    ...
                                    <div class="form-group col-sm-12 ">
                                        ...
                                        <input type="text" name="fullName_2" id="fullName_2" required
                                            class="form-control wizard-required"
                                            value="@if ($user->fullName_2) {{ $user->fullName_2 }} @endif">
                                    </div>
                                    <div class="form-group col-sm-6 ">
                                        <label for="PostCategoryId" class="is-required">Select Relation</label>
                                    ...
                                    <div class="form-group col-sm-6 ">
                                        <label for="relative_mobile" class="is-required">Mobile
                                            Number</label>
                                        <input name="relative_mobile_2" type="number"
                                            class="form-control wizard-required" id="relative_mobile" required
                                ...
                                <div class="form-group custom-control custom-checkbox mt-3">
                                    <input name="is_committed" type="checkbox"
                                        class="custom-control-input wizard-required" id="is_committed" required
                                        autocomplete="off" @if ($user->is_committed == 1) checked @endif>
                                ...
                                <div class="btncen2 d-flex justify-content-between mt-5 col-12 pl-0">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <button class="personal_info_save4 border form-wizard-submit btn btn-primary "
                                            type="submit"> Submit
                                        </button>
                                    </div>
                                </div>
...
@section('script')
    ...
    <script>
        ...
        $(".personal_info_save1").on("click", function() {
            if (document.getElementsByName('educational_level') != '' && document.getElementsByName('field') !=
                '' && document.getElementsByName('educational_status') != '' && document.getElementsByName(
