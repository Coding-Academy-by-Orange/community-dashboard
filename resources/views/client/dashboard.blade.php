                ...
                <div class="col-lg-4 mt-lg-5 md-col-12 ">
                    <div class="row mr-lg-1 mb-lg-1 " style=" margin-top: 30px">
                        ...
                        <div class="col-lg-12 mb-3 ">
                            ...
                            <span class="form-text small  text-capitalize font-weight-bold" id="helpTextFile" style="color: #f16e00">Don't worry, you still have time to login again many times, and to complete all the requirements until Mar.31th, 2022!</span>
