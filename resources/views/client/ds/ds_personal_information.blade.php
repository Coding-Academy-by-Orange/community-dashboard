                            ...
                            <form class="personal-info-step1" action="javascript:void(0)">
                                ...
                                <div class="col-sm-12  ">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-1 form-group">
                                                ...
                                                <select name="educational_level" class="custom-select wizard-required"
                                                    ...
                                                    <option value="ph.D."
                                                            @if($user->educational_level == "ph.D." ) selected @endif >
                                                        Ph.D.
                                                    </option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-sm-12">
                                            <div class="mb-1 form-group">
                                                <label for="field_of_study" class="is-required">Field of Study</label>
                                                <select name="field_of_study" class="custom-select wizard-required"
                                                        id="field_of_study" required>
                                                    <option value="">
                                                        Select..
                                                    </option>
                                                    <option value="science"
                                                            @if($user->field_of_study == "science" ) selected @endif >
                                                        Science
                                                    </option>
                                                    <option value="technology"
                                                            @if($user->field_of_study == "technology" ) selected @endif >
                                                        Technology
                                                    </option>
                                                    <option value="engineering"
                                                            @if($user->field_of_study == "engineering" ) selected @endif >
                                                        Engineering
                                                    </option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-sm-12">
                                            <div class="mb-1 form-group">
                                                <label for="filed_of_specialization" class="is-required">Field of
                                                    Specialization</label>
                                                <select name="field_of_specialization"
                                                        class="custom-select wizard-required"
                                                        id="filed_of_specialization" required>
                                                    <option value="">
                                                        Select..
                                                    </option>
                                                    <option value="Civil Engineering"
                                                            @if($user->field_of_specialization == "Civil Engineering" ) selected @endif >
                                                        Civil Engineering
                                                    </option>

                                                    <option value="Nuclear Engineering"
                                                            @if($user->field_of_specialization == "Nuclear Engineering" ) selected @endif >
                                                        Nuclear Engineering
                                                    </option>

                                                    <option value="Chemical Engineering"
                                                            @if($user->field_of_specialization == "Chemical Engineering" ) selected @endif >
                                                        Chemical Engineering
                                                    </option>

                                                    <option value="Industrial Engineering"
                                                            @if($user->field_of_specialization == "Industrial Engineering" ) selected @endif >
                                                        Industrial Engineering
                                                    </option>

                                                    <option value="Electrical Engineering"
                                                            @if($user->field_of_specialization == "Electrical Engineering" ) selected @endif >
                                                        Electrical Engineering
                                                    </option>

                                                    <option value="Architectural Engineering"
                                                            @if($user->field_of_specialization == "Architectural Engineering " ) selected @endif >
                                                        Architectural Engineering
                                                    </option>

                                                    <option value="Mechanical Engineering"
                                                            @if($user->field_of_specialization == "Mechanical Engineering" ) selected @endif >
                                                        Mechanical Engineering
                                                    </option>

                                                    <option value="Computer Engineering"
                                                            @if($user->field_of_specialization == "Computer Engineering" ) selected @endif >
                                                        Computer Engineering
                                                    </option>

                                                    <option value="Mechatronics Engineering"
                                                            @if($user->field_of_specialization == "Mechatronics Engineering" ) selected @endif >
                                                        Mechatronics Engineering
                                                    </option>

                                                    <option value="Biology"
                                                            @if($user->field_of_specialization == "Biology" ) selected @endif >
                                                        Biology
                                                    </option>

                                                    <option value="Chemistry"
                                                            @if($user->field_of_specialization == "Chemistry" ) selected @endif >
                                                        Chemistry
                                                    </option>

                                                    <option value="Mathematics"
                                                            @if($user->field_of_specialization == "Mathematics" ) selected @endif >
                                                        Mathematics
                                                    </option>

                                                    <option value="Physics"
                                                            @if($user->field_of_specialization == "Physics" ) selected @endif >
                                                        Physics
                                                    </option>

                                                    <option value="Geology"
                                                            @if($user->field_of_specialization == "Geology" ) selected @endif >
                                                        Geology
                                                    </option>

                                                    <option value="Astronomy"
                                                            @if($user->field_of_specialization == "Astronomy" ) selected @endif >
                                                        Astronomy
                                                    </option>

                                                    <option value="Computer Science"
                                                            @if($user->field_of_specialization == "Computer Science" ) selected @endif >
                                                        computer Science
                                                    </option>

                                                    <option value="computer information systems"
                                                            @if($user->field_of_specialization == "computer information systems" ) selected @endif >
                                                        computer information systems
                                                    </option>

                                                    <option value="Data Science and Artificial Intelligence"
                                                            @if($user->field_of_specialization == "Data Science and Artificial Intelligence" ) selected @endif >
                                                        Data Science and Artificial Intelligence
                                                    </option>

                                                    <option value="Software Engineering"
                                                            @if($user->field_of_specialization == "Software Engineering" ) selected @endif >
                                                        Software Engineering
                                                    </option>

                                                    <option value="Computer Graphics and Animation"
                                                            @if($user->field_of_specialization == "Computer Graphics and Animation" ) selected @endif >
                                                        Computer Graphics and Animation
                                                    </option>

                                                    <option value="Enterprise Systems Engineering"
                                                            @if($user->field_of_specialization == "Enterprise Systems Engineering" ) selected @endif >
                                                        Enterprise Systems Engineering
                                                    </option>

                                                    <option value="Cybersecurity"
                                                            @if($user->field_of_specialization == "Cybersecurity" ) selected @endif >
                                                        Cybersecurity
                                                    </option>

                                                    <option value="Business information technology"
                                                            @if($user->field_of_specialization == "Business information technology" ) selected @endif >
                            ...
                            <form class="personal-info-step3" action="javascript:void(0)">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12 ">
                                        <label for="address" class="is-required">Do you have any disabilities</label>
                                        <select name="disability" required
                                            ...
                                            <option value="yes"  @if($user->disability == "yes" ) selected @endif>
                                                Yes
                                            </option>
                                            <option value="no" @if($user->disability == "no" ) selected @endif>
                                                No
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group col-sm-12 ">
                                        ...
                                        <select name="know_us" required
                                                class="custom-select wizard-required"
                                                id="PostCategoryId">
                                            <option value="Select..">
                                                Select..
                                            </option>
                                            <option value="social media" @if($user->know_us == "social media" ) selected @endif>
                                                Social Media
                                            </option>
                                            <option value="media" @if($user->know_us == "media" ) selected @endif>
                                                Media(Radio,TV,Press)
                                            </option>
                                            <option value="sms" @if($user->know_us == "sms" ) selected @endif>SMS</option>
                                            <option value="awareness-sessions" @if($user->know_us == "awareness-sessions" ) selected @endif>Awareness Sessions</option>
                                            <option value="friend" @if($user->know_us == "friend" ) selected @endif>Recommendation from a friend</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <form class="personal-info-step4" method="post"
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <select name="relative_relation_1" required
                                                class="custom-select wizard-required"
                                                id="PostCategoryId">
                                            <option value="Select..">
                                                Select..
                                ...
                                <div class="form-group custom-control custom-checkbox mt-3">
                                    <input name="is_committed" type="checkbox"
                                           class="custom-control-input wizard-required"
                                           id="is_committed"
                                           required
                                           autocomplete="off"
