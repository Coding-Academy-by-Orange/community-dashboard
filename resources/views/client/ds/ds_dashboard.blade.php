...
@media screen and (max-width: 600px) {
                                            ...
                                            <div class="row flexDirection ">
                                                ...
                                                <div class=" align-items-center col-lg-4 d-flex justify-content-between ">
                                                    <div class="card-text mr-5">
                                                        @if($information->educational_level != null && $information->field_of_study != null && $information->field_of_specialization != null && $information->ar_writing != null && $information->ar_speaking != null &&
    ...
    && $information->relative_mobile_2 != null &&  $information->relative_relation_2 != null &&  $information->is_committed == 1)
                                                        ...
                                                        @elseif($information->educational_level == null && $information->field_of_study != null && $information->field_of_specialization != null  && $information->ar_writing == null && $information->ar_speaking == null &&
    $information->en_writing == null && $information->en_speaking == null && $information->city == null  && $information->relative_mobile_1 == null && $information->relative_relation_1 == null
    && $information->relative_mobile_2 == null &&  $information->relative_relation_2 == null &&  $information->is_committed == null)
                                        ...
                                        <div class="card-body">
                                            <div class="row flexDirection">
                                                ...
                                                <div class="align-items-center d-flex justify-content-between  col-lg-4 ">
                                                    <div class="card-text mr-5 ">
                                                        @if( auth()->user()->questionnaires->count() == App\Questionnaire::where('academy_location','data science')->count())
                                                            <i style="color: limegreen " class=" fas fa-check "></i>
                                                            Completed
                            ...
                            <div class="btnM mt-1 my-1">
                                ...
                                <button class="submit-button btn btn-primary btn-lg btn-block" data-toggle="modal"
                                        data-target="#submitModalCenter" @if((App\CodeChallenge::where('user_id', auth()->id())->first() != null) && (App\EnglishQuiz::where('user_id', auth()->id())->first() != null )&& (App\Questionnaire
...
::where('academy_location','data science')->count() == auth()->user()->questionnaires->count()) && (auth()->user()->educational_level != null) && $information->field_of_study != null && $information->field_of_specialization != null && (auth()->user()->ar_writing != null) && (auth()->user()->ar_speaking != null )&&
