                            ...
                            <li class="dropdown dropdown-user nav-item">
                                <a class="dropdown-toggle nav-link dropdown-user-link " href="javascript:void(0);"
                                    ...
                                    <div class="user-nav d-sm-flex d-none d-flex flex-row">
                                        ...
                                        <span
                                            class="user-name text-capitalize">{{ Auth::guard('admin')->user()->fname }}
                                        </span>
        ...
        <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
            ...
            <div class="main-menu-content">
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation"
                    ...
                    <li class=" nav-item"><a href="{{ route('users.index') }}"><i
                    ...
                    @if (Auth::user()->is_super)
                        ...
                        <li class=" nav-item"><a href="{{ route('questionnaires.index') }}"><i
                                    class="bx bx-help-circle"></i><span class="menu-title text-truncate">Manage
                                    Questionnaires </span></a>
                        </li>
                        <li class=" nav-item"><a href="{{ route('admins.index') }}"><i
                                    class="bx bx-user-circle"></i><span class="menu-title text-truncate"> Manage
                                    Admins </span></a>
                        </li>
                    @endif
                </ul>
