                        ...
                        <div class="card-body pb-0 mx-25">
                            ...
                            <div class="card widget-user-details">
                                <div class="card-header d-flex justify-content-between align-items-center px-0">
                                    <div>
                                        <h3 class="text-capitalize mb-1">{{ $user->en_first_name }}
                                            {{ $user->en_second_name }} {{ $user->en_third_name }} {{ $user->en_last_name }}
                                        </h3>
                                        <div class="card-subtitle">#{{ $user->id }}
                                            @if ($user->result_1 == '1. Accepted – 1st Filtration – Orange')
                                                | <span class="badge badge-light-success mb-1 ">{{ $user->result_1 }}</span>
                                            ...
                                            @elseif($user->result_1 == '3. Rejected – Age – Orange')
                                                | <span class="badge badge-light-danger mb-1 ">{{ $user->result_1 }}</span>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select
                                                                ...
                                                                @if ($user->result_1 == '1. Accepted – 1st Filtration – Orange')
                                                                    ...
                                                                    <option value="4. Rejected – 1st Filtration – Orange">4.
                                                                        Rejected – 1st Filtration – Orange
                                                                    </option>
                                                                    <option value="5. Accepted – Pre Final List – Simplon">
                                                                    ...
                                                                    <option value="8. Rejected – Motivational Qs – Simplon">
                                                                ...
                                                                @elseif($user->result_1 == '2. Maybe – 1st Filtration – Orange')
                                                                    <option value="1. Accepted – 1st Filtration – Orange">1.
                                                                ...
                                                                @elseif($user->result_1 == '6. Accepted – Final List – Simplon')
                                                                    <option value="1. Accepted – 1st Filtration – Orange">
                                                                        1.
                                                                        Accepted – 1st Filtration – Orange
                                                                    </option>
                                                                    <option value="2. Maybe – 1st Filtration – Orange">
                                                                    ...
                                                                    <option value="4. Rejected – 1st Filtration – Orange">
                                                                        4.
                                                                        Rejected – 1st Filtration – Orange
                                                                    </option>
                                                                    <option value="5. Accepted – Pre Final List – Simplon">
                                ...
                                <div class="tab-content text-justify">
                                    <div class="tab-pane fade active show" id="list-sunday" role="tabpanel"
                                        ...
                                        <div class="d-flex justify-content-start align-items-center mb-2">
                                            ...
                                            @if (
                                                $user->educational_level != null &&
                                                    $user->educational_background != null &&
                                                    $user->ar_writing != null &&
                                                    $user->ar_speaking != null &&
                                                    $user->en_writing != null &&
                                                    $user->en_speaking != null &&
                                                    $user->city != null &&
                                                    $user->address != null &&
                                                    $user->relative_mobile_1 != null &&
                                                    $user->relative_relation_1 != null &&
                                                    $user->relative_mobile_2 != null &&
                                                    $user->relative_relation_2 != null &&
                                                    $user->is_committed != null)
                                        ...
                                        <div class="row ">
                                            <div class="col-sm-6 col-12 mt-1 ">
                                                <div class="p-1 border">
                                                    ...
                                                    <div class="mb-1">
                                                        <span class="text-capitalize">{{ $user->en_first_name }}
                                                            {{ $user->en_second_name }} {{ $user->en_third_name }}
                                                            {{ $user->en_last_name }}</span>
                                                    </div>
                                                    <h6 class="invoice-from ">Full Name in Arabic:</h6>
                                                    <div class="mb-1 d-flex justify-content-end">
                                                        <span>{{ $user->ar_first_name }} {{ $user->ar_second_name }}
                                                            {{ $user->ar_third_name }} {{ $user->ar_last_name }}</span>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col">
    ...
    @endif
                                                ...
                                                <div class="mb-2 mt-2 p-1 border">
                                                    ...
                                                    <div class="row">
                                                        <div class="col"><img class="img-fluid"
                                                                src="/storage/{{ $user->id_img }}" alt=""></div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-6 col-12 mt-1">
                                                ...
                                                <div class="mb-2 mt-2 p-1 border">
                                                    ...
                                                    <div class="row">
                                                        <div class="col"><img class="img-fluid"
                                                                src="/storage/{{ $user->vaccination_img }}"
                                                                alt=""></div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    @foreach ($questionnaires as $questionnaire)
                                                        <div class="card collapse-header">
                                                            ...
                                                            <div id="collapse1" role="tabpanel"
                                                                aria-labelledby="headingCollapse1" class="collapse"
                                                                style="">
                                                                <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="col-9">
                                                    <div class="mr-1 mb-1">Account link:
                                                        ...
                                                        @else
                                                            <a
                                                                href="{{ $english_account_link }}">{{ $english_account_link }}</a>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="card widget-todo">
                    <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                        ...
                        @elseif($user->status == '1. Accepted – 1st Filtration – Orange')
                            <span class="badge badge-light-success">1. Accepted – 1st Filtration – Orange</span>
                        @elseif($user->status == '2. Maybe – 1st Filtration – Orange')
                            <span class="badge badge-light-secondary ">2. Maybe – 1st Filtration – Orange</span>
                        @elseif($user->status == '3. Rejected – Age – Orange')
                            <span class="badge badge-light-danger ">3. Rejected – Age – Orange</span>
                        @elseif($user->status == '4. Rejected – 1st Filtration – Orange')
                            <span class="badge badge-light-danger ">4. Rejected – 1st Filtration – Orange</span>
                        @elseif($user->status == '5. Accepted – Pre Final List – Simplon')
                            <span class="badge badge-light-success ">5. Accepted – Pre Final List – Simplon</span>
                        @elseif($user->status == '6. Accepted – Final List – Simplon')
                            <span class="badge badge-light-success">6. Accepted – Final List – Simplon</span>
                        @elseif($user->status == '7. Rejected – Test Result (Sololearn + English) ')
                            <span class="badge badge-light-danger ">7. Rejected – Test Result (Sololearn + English) </span>
                        @elseif($user->status == '8. Rejected – Motivational Qs – Simplon')
                            <span class="badge badge-light-danger ">8. Rejected – Motivational Qs – Simplon</span>
                        @elseif($user->status == '9. Accepted – 50 Students After Interviews – Orange')
                            <span class="badge badge-light-success ">9. Accepted – 50 Students After Interviews –
                                Orange</span>
                        @elseif($user->status == '10. Maybe – Final List After Interviews - Orange')
                            <span class="badge badge-light-secondary ">10. Maybe – Final List After Interviews -
                                Orange</span>
                        @elseif($user->status == '11. Rejected – Final List After Interviews - Orange')
                            <span class="badge badge-light-danger ">11. Rejected – Final List After Interviews -
                                Orange</span>
                        @endif
                    </div>
                </div>
                <div id="table-statistics-two">
                    <div class="card" style="">
                        ...
                        <div class="col"><img class="img-fluid" src="/storage/{{ $user->personal_img }}"
                                alt=""></div>
