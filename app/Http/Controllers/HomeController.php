...
class HomeController extends Controller
{
    ...
    public function showDashboard()
    {
        if (auth()->user()->is_email_verified == 0) {
            ...
            if (auth()->user()->academy_location == 'data science') {
                ...
                return view('client.ds.ds_dashboard')->with('information', User::where('id', auth()->id())->first());
    ...
    public function submission()
    {
        if (auth()->user()->is_submitted == 0) {
            ...
            if (auth()->user()->academy_location == 'data science') {
                if ((CodeChallenge::where('user_id', auth()->id())->first() != null) && (EnglishQuiz::where('user_id', auth()->id())->first() != null) && (Questionnaire::where('academy_location','data science')->count()  == auth()->user()->questionnaires->count()) && (auth()->user()->educational_level != null) && auth()->user()->field_of_study != null && auth()->user()->field_of_specialization != null  && (auth()->user()->ar_writing != null) && (auth()->user()->ar_speaking != null) &&
